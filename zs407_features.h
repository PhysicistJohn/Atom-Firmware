...
#if ZS407_PHASE_BUILD && ZS407_PHASE >= 1
#define ZS407_FEATURE_HOST_CONTRACT 1
#define ZS407_FEATURE_HARD_FAULT_VENEER 1
#else
#define ZS407_FEATURE_HOST_CONTRACT 0
#define ZS407_FEATURE_HARD_FAULT_VENEER 0
#endif
