...
enum {
  ...
  ZS407_CAP_DEVICE_TIMESTAMPS = UINT32_C(1) << 15,
  ZS407_CAP_PASSIVE_STREAM_ENGINE = UINT32_C(1) << 16,
  ZS407_CAP_ADAPTIVE_SCAN_PLANNER = UINT32_C(1) << 17,
  ZS407_CAP_ZERO_SPAN_FFT_CAPTURE = UINT32_C(1) << 18,
  ZS407_CAP_BINARY_TRANSPORT_QUALIFICATION = UINT32_C(1) << 19
};
...
enum {
  ...
  ZS407_SAFETY_PASSIVE_EXECUTION_LOCKED = UINT32_C(1) << 6,
  ZS407_SAFETY_CLOCK_NOT_DISCIPLINED = UINT32_C(1) << 7,
  ZS407_SAFETY_ADAPTIVE_EXECUTION_LOCKED = UINT32_C(1) << 8,
  ZS407_SAFETY_TRANSPORT_QUALIFICATION_ONLY = UINT32_C(1) << 9
};
