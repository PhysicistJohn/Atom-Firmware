...
enum {
  ...
  ZS407_CAP_TYPED_PROTOCOL_V2 = UINT32_C(1) << 11,
  ZS407_CAP_STREAMING_MARSHALLING = UINT32_C(1) << 12,
  ZS407_CAP_COMPACT_STORAGE_CODECS = UINT32_C(1) << 13,
  ZS407_CAP_ASYNC_USB_LAB = UINT32_C(1) << 14
};
...
enum {
  ...
  ZS407_SAFETY_BINARY_TRANSPORT_LOCKED = UINT32_C(1) << 4,
  ZS407_SAFETY_HARDWARE_CRC_UNQUALIFIED = UINT32_C(1) << 5
};
